...
`Fotos` tiene un link por foto (una por línea dentro de la celda) a una copia guardada en la carpeta de Drive "Déco Porteño - fotos", creada automáticamente junto al Sheet la primera vez que corre.
